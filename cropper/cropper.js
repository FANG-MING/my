...
!function(e, o) {
    ...
    return Object.assign(v.prototype, h), v.prototype.prepare = function() {
        ...
        t.updateCanvas = function() {
            ...
            wx.getImageInfo({
                ...
                success: function(e) {
                    ...
                    t.croperTarget = e.path, o < s / f ? (t.rectX = c, t.baseWidth = s, t.baseHeight = s / o, 
                    t.rectY = u - Math.abs((f - t.baseHeight) / 2)) : (t.rectY = u, t.baseWidth = f * o, 
                    t.baseHeight = f, t.rectX = c - Math.abs((s - t.baseWidth) / 2)), t.imgLeft = t.rectX, 
                    t.imgTop = t.rectY, t.scaleWidth = t.baseWidth, t.scaleHeight = t.baseHeight, t.updateCanvas(), 
                    "function" == typeof t.onImageLoad && t.onImageLoad(t.ctx, t);
                }
            }), t.update(), t;
